...
I am a Ph.D. student in Design at North Carolina State University, with research interests in building energy systems, grid-interactive buildings, and data-driven energy analytics. I am also pursuing graduate study in Electrical and Computer Engineering to strengthen my work at the intersection of buildings, power systems, and machine learning.

My research focuses on data-driven methods for understanding how buildings and electric grids interact under normal, extreme, and recovery conditions. Current directions include power outage forecasting, building-grid resilience, heat pump identification from electricity and weather data, and thermal-aware operation of high-performance computing environments.

Before joining NC State, I worked on building energy performance assessment, zero-energy building policy, geothermal heat pump system design, and low-carbon building retrofitting. My broader goal is to develop practical analytics that can support energy efficiency, electrification planning, grid reliability, and resilient building-grid operation.
